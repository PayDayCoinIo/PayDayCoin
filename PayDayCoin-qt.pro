...
win32:LIBPNG_INCLUDE_PATH=$$PWD/../depencies/libpng-1.6.16
win32:LIBPNG_LIB_PATH=$$PWD/../depencies/libpng-1.6.16/.libs
...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CFLAGS += -mmacosx-version-min=10.12
    macx:QMAKE_LFLAGS += -mmacosx-version-min=10.12
    macx:QMAKE_OBJECTIVE_CFLAGS += -mmacosx-version-min=10.12 
