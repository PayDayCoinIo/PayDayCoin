...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("protocolversion",(int)ProtocolVersion()));
#ifdef ENABLE_WALLET
    if (pwalletMain) {
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <PayDayaddress>\n"
            "Return information about <PayDayaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <PayDaypubkey>\n"
            "Return information about <PayDaypubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <PayDayaddress> <signature> <message>\n"
